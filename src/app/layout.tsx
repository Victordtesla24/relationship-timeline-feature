...
// Dynamically import MonitoringInitializer with no SSR to safely access window
const MonitoringInitializer = dynamic(() => import('@/components/MonitoringInitializer'), { ssr: false });
