...
import { updateRelationship, Relationship } from '@/utils/localStorage';
...
export default function EditRelationshipModal({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Update relationship in localStorage
      updateRelationship(relationship._id, {
        name: formData.name,
      ...
      setSubmitError('Failed to update relationship. Please try again.');
    } finally {
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Edit Relationship</h3>
                <p className="text-primary-100 text-sm mt-1">Update this relationship's details</p>
